...
### Made with vanilla CSS and [Tone.js](https://github.com/Tonejs/Tone.js)
...
ascii-tone runs best on google chrome or mozilla firefox, but will also work with many mobile devices. As of 4/9/20 the text interface is not 100% compatible with Windows, though the software still functions.
